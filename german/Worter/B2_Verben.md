...
| [verschwiegen](https://dict.naver.com/dekodict/#/search?range=all&query=verschwiegen) | 1. p.p. ↑ verschweigen. 2. p.a. 입이 무거운, 비밀을 잘 지키는, 과묵한. 3. p.a. 숨겨진, 한적한 |
...
| [stöhnen](https://dict.naver.com/dekodict/#/search?range=all&query=stöhnen) | 신음하다, 끙끙거리다, 불평하다, 하소연하다 (재귀) ~에 시달리다 |
...
| [übertreffen](https://dict.naver.com/dekodict/#/search?range=all&query=übertreffen), übertraf, hat übertroffen | 능가하다, 뛰어넘다 |
...
| [erhalten](https://dict.naver.com/dekodict/#/search?range=all&query=erhalten) | 얻다, 보존하다, 부양하다 |
...
| [beschränken](https://dict.naver.com/dekodict/#/search?range=all&query=beschränken) | 제한하다, 한정하다 |
...
| [zeigen](https://dict.naver.com/dekodict/#/search?range=all&query=zeigen) | 보여주다, 가르쳐주다, 알리다 |
...
| [einschätzen](https://dict.naver.com/dekodict/#/search?range=all&query=einschätzen) | 평가하다, 판정하다, ~의 가치를 인정하다 |
...
| [entgehen](https://dict.naver.com/dekodict/#/search?range=all&query=entgehen) | 1. i. 2. i. et.3 entgehen 무엇을 모면{피}하다. 3. i. |
...
| [deponieren](https://dict.naver.com/dekodict/#/search?range=all&query=deponieren) | 1. t. [상업] 공탁하다, 기탁하다; 보관하다, 저장하다 2. t. [법률•구식] 증언하다 |
...
| [bedrohen](https://dict.naver.com/dekodict/#/search?range=all&query=bedrohen) | 1. t. 위협하다, 협박하다 2. t. 위태롭게 하다 |
...
| [ansiedeln](https://dict.naver.com/dekodict/#/search?range=all&query=ansiedeln) | 1. t. 이주{정착}시키다. 2. t. (소속•시대 등을) ∙∙∙에 포함시키다, ∙∙∙으로 분류하다 3. refl. sich ansiedeln 이주{정착}하다; (식물이) 뿌리를 내리다. |
...
| [vollklimatisiert](https://dict.naver.com/dekodict/#/search?range=all&query=vollklimatisiert) | 1. 냉난방 시설을 완비한 |
| [abwohnen](https://dict.naver.com/dekodict/#/search?range=all&query=abwohnen) | 1. t. eine Wohnung abwohnen 오래 살아서 집을 낡게 하다. 2. t. ein Darlehen abwohnen 빌려준 돈을 집세로 상쇄하게 하다. 3. i. 떨어져 살다. |
| [aussetzen](https://dict.naver.com/dekodict/#/search?range=all&query=aussetzen) | 1. t. 2. t. 밖에 내놓다 3. t. 버리다 |
| [bieten](https://dict.naver.com/dekodict/#/search?range=all&query=bieten) | 1. t. 2. t. 제공하다, 내어놓다 3. t. [상업] feilbieten 팔려고 내어놓다 |
| [verwirklichen](https://dict.naver.com/dekodict/#/search?range=all&query=verwirklichen) | 1. t. 2. t. 실현하다, 실행하다, 현실화하다 3. refl. |
| [besetzen](https://dict.naver.com/dekodict/#/search?range=all&query=besetzen) | 1. t. 올려놓다, 차리다 2. t. 차지하다, (군대가) 점령하다, (시위대가) 점거하다 3. t. (지위•빈자리를) 채우다 |
| [übertragen](https://dict.naver.com/dekodict/#/search?range=all&query=übertragen) 1 | 1. t. 2. t. 이송하다, 전송하다, 운송하다, 운반하다; 전달하다 3. t. 맡기다, 위임하다, 양도하다 |
| [hereinlegen](https://dict.naver.com/dekodict/#/search?range=all&query=hereinlegen) | 1. t. 안으로 넣다;«구어»속이다; 해치다, 그르치다 2. refl.sich hereinlegen (잠자리에) 들다. |
| [ausnutzen](https://dict.naver.com/dekodict/#/search?range=all&query=ausnutzen) | 1. t. (철저하게) 이용하다; 착취하다 |
| [heucheln](https://dict.naver.com/dekodict/#/search?range=all&query=heucheln) | 1. i. 위선적으로 행동하다, 속임수를 쓰다; 신앙심이 깊은 체하다. 2. t. (없는 감정이나 특성을) 있는 체하다 |
| [schwindeln](https://dict.naver.com/dekodict/#/search?range=all&query=schwindeln) 1 | 1. i.(+haben)/imp. 어지럽다, 현기증이 나다 2. i.(+haben)/imp. 사기치다, 속임수를 쓰다; 속이다 3. t. 밀수하다, 속임수로 반입하다. |
| [vortäuschen](https://dict.naver.com/dekodict/#/search?range=all&query=vortäuschen) | 1. t. 그럴싸하게 보이게 하다, 속여서 믿게 하다 |
| [entsprechen](https://dict.naver.com/dekodict/#/search?range=all&query=entsprechen) | 1. i. et.3 entsprechen 무엇에 상응하다, 일치하다; (목적에) 알맞다; 응하다, 따르다 |
| [ausbleiben](https://dict.naver.com/dekodict/#/search?range=all&query=ausbleiben) | 1. i. 밖에 머무르다, 외출{부재} 중이다 2. i. 생기지{일어나지•오지} 않다 3. i. 지체하다, 머뭇거리다 |
| [bevorzugen](https://dict.naver.com/dekodict/#/search?range=all&query=bevorzugen) | 1. t. 우대하다; 선호하다 2. p.a. ↑ bevorzugt |
| [vorziehen](https://dict.naver.com/dekodict/#/search?range=all&query=vorziehen) | 1. t. (∙∙∙앞에) 끌어당기다{치다} 2. t. 끌어내다 3. t. 앞으로 끌다 |
| [täuschen](https://dict.naver.com/dekodict/#/search?range=all&query=täuschen) | 1. t./i. 속이다, 기만하다; 속여 빼앗다, 편취하다; 잘못된 인상을 주다, 착각하게 하다 2. t./i. 3. t./i. [스포츠] 속이는 동작을 하다 |
| [anschwindeln](https://dict.naver.com/dekodict/#/search?range=all&query=anschwindeln) | 1. t. (jn.) 속이다; (jm.et.) 속여서 팔아넘기다. |
| [schlimm](https://dict.naver.com/dekodict/#/search?range=all&query=schlimm) | 1. 좋지 않은, 나쁜, 곤란한, 심한 2. 심각한, 중대한, 매우 우려되는, 불리한 3. 못된, (도덕적으로) 나쁜, 고약한 |
| [zugeben](https://dict.naver.com/dekodict/#/search?range=all&query=zugeben) | 1. t. 2. t. 부가하다, 첨가하다; 덤{경품}으로 주다 3. t. [카드] 요구된 같은 짝의 패를 내놓다 |
| [erledigen](https://dict.naver.com/dekodict/#/search?range=all&query=erledigen) | 1. t. 2. t. (업무를) 처리하다, 끝내다; (문제를) 해결하다 3. t. «구어>> (누구를) 끝장내다, 파멸시키다; 매장하다 |
| [sperren](https://dict.naver.com/dekodict/#/search?range=all&query=sperren) | 1. t. 차단하다, 저지하다, 제지하다; 폐쇄하다, 봉쇄하다 2. t. 3. t. 차단하다, 저지하다, 제지하다; 폐쇄하다, 봉쇄하다 |
| [aufrufen](https://dict.naver.com/dekodict/#/search?range=all&query=aufrufen) | 1. t. 호명하다 2. t. 촉구하다 3. t. 일깨우다, 호소하다 |
| [verändern](https://dict.naver.com/dekodict/#/search?range=all&query=verändern) | 1. t. 2. t. 바꾸다, 변화시키다, 변경하다 3. t. |
| [verfassen](https://dict.naver.com/dekodict/#/search?range=all&query=verfassen) | 1. t. «고어» 붙잡다. 2. t. (편지•작품을) 쓰다, (문서를) 작성{기초}하다; (시를) 짓다, 저작하다. 3. t. 잘못 끼우다 |
| [ergänzen](https://dict.naver.com/dekodict/#/search?range=all&query=ergänzen) | 1. t. 보충하다, 보완하다, 온전{완전}히 하다 2. refl. 보충되다, 채워지다; 서로 보완하다 |
| [wagen](https://dict.naver.com/dekodict/#/search?range=all&query=wagen) | 1. t. 감행하다, 과감히 시도하다 2. t. (과감히) 걸다 3. refl. 두려워하지 않고 나아가다 |
| [schiefgehen](https://dict.naver.com/dekodict/#/search?range=all&query=schiefgehen) | 1. i. (일이) 실패하다 |
| [abschließen](https://dict.naver.com/dekodict/#/search?range=all&query=abschließen) | 1. t. 자물쇠로 채우다, 잠그다 2. t. 3. t. 폐쇄하다, 차단하다, 격리하다 |
| [betreiben](https://dict.naver.com/dekodict/#/search?range=all&query=betreiben) | 1. t. (기계 등을) 가동하다 2. t. 가속화{촉진}시키다 3. t. 경영하다; 종사하다; 행하다 |
...
| [zurückziehen](https://dict.naver.com/dekodict/#/search?range=all&query=zurückziehen) | 1. t. 원위치로{뒤로} 잡아당기다; 물러나게 하다, 쑥 들어가게 하다 2. t. «비유» 철회하다, 취소하다, (고소를) 취하하다 3. t. 회수하다 |
| [vereinsamen](https://dict.naver.com/dekodict/#/search?range=all&query=vereinsamen) | 1. t. «드물게» 고립시키다, 고독하게 만들다 2. i.(+sein)/refl. (sich) vereinsamen 고립되다, 고독하게 되다. |
| [wegbrechen](https://dict.naver.com/dekodict/#/search?range=all&query=wegbrechen) | 1. i. 부러지다. 2. t. (a) 부러뜨리다; 깨뜨려 제거하다, 꺾어내다. (b)«의학»토하다, 게우다. |
| [brechen](https://dict.naver.com/dekodict/#/search?range=all&query=brechen) | 1. t. 2. t. 깨다, 부수다, 쪼개다, 부러뜨리다, 꺾다, 뜯다 3. t. (돌을) 잘라 내다, 채석하다: (밭을) 쟁기질하다 |
| [angeben](https://dict.naver.com/dekodict/#/search?range=all&query=angeben) | 1. t. 신고하다, 보고하다, 진술하다, 제시하다 2. t. 결정하다, 지정하다; 표시하다 3. t. 고발하다, 고자질하다, 밀고하다 |
...
| [sparen](https://dict.naver.com/dekodict/#/search?range=all&query=sparen) | 1. t. 절약하다, 아끼다 2. t. 저축하다; 남기다 3. t. (불필요한 일로) 제쳐 두다; 연기하다 |
| [berücksichtigen](https://dict.naver.com/dekodict/#/search?range=all&query=berücksichtigen) | 1. t. 고려하다, 참작하다 2. t. «농담» 무엇에 등을 돌리다 |
| [ạb\|haken](https://dict.naver.com/dekodict/#/entry/deko/f04d9857380b49789edd131d4c273e71) | 1. t. ∙∙∙의 갈고리{단추}를 풀다, 갈고리에서 벗기다{풀다}. 2. t. 갈고리로 벗기다{풀다} 3. t. 갈고리표(∨) 를 붙이다(처리되었음을 뜻함) |
| [heben](https://dict.naver.com/dekodict/#/search?range=all&query=heben) | 1. t. 2. t. 올리다, 들어 올리다; 높이다 3. t. 들어 움직이다, 옮기다 |
| [aufheben](https://dict.naver.com/dekodict/#/search?range=all&query=aufheben) | 1. t. 2. t. 들어 올리다; (바닥에서) 주워{집어} 올리다 3. t. «구식•아어» 몸을 일으키다, 일어서다 |
| [einschätzen](https://dict.naver.com/dekodict/#/search?range=all&query=einschätzen) | 1. t. 감정{평가}하다>; ∙∙∙의 가치를 인정하다 2. t. (세금•재산을) 사정하다 |
| [abhaken](https://dict.naver.com/dekodict/#/search?range=all&query=abhaken) | 1. 확인하다 |
| [Vereinbarkeit](https://dict.naver.com/dekodict/#/search?range=all&query=Vereinbarkeit) | 1. 적합성 ; 호환성 |
| [verbieten](https://dict.naver.com/dekodict/#/search?range=all&query=verbieten) | 1. t. 2. t. 금하다, 금지하다 3. t. (법적으로) 금지하다 |
| [betragen](https://dict.naver.com/dekodict/#/search?range=all&query=betragen) | 1. i. 어떤 금액{수치}에 달하다 2. refl. 행동하다 |
| [bestimmen](https://dict.naver.com/dekodict/#/search?range=all&query=bestimmen) | 1. t. 2. t. 정하다, 결정{확정•규정}하다 3. t. 명하다, 지정{선정}하다; 예정하다 |
| [kontrollieren](https://dict.naver.com/dekodict/#/search?range=all&query=kontrollieren) | 1. t. 검사하다, 감독하다; 통제하다, 지배하다; 제어하다, 조종하다 2. i. [해양] 초계하다, 순회하다 |
| [Behördengang](https://dict.naver.com/dekodict/#/search?range=all&query=Behördengang) | 1. 업무 차 관청 방문 (관공서에 일 보러 감) |
| [anrechnen](https://dict.naver.com/dekodict/#/search?range=all&query=anrechnen) | 1. t. 계산하다, 계산(서)에 올리다, 청구하다 2. t. 누구의 무엇을 평가하다, (공로•죄과 등을) 누구에게 돌리다 3. t. (값을) 쳐 주다 |
| [feststehen](https://dict.naver.com/dekodict/#/search?range=all&query=feststehen) | 1. i. 확정{결정}되어 있다 2. i. 확실하다 |
| [sprechen](https://dict.naver.com/dekodict/#/search?range=all&query=sprechen) | 1. i. 말하다, 이야기하다, 담화하다, 대화하다; 지껄이다, 담소하다; 담론하다; 연설하다 2. i. «전치사와 함께»auf jn. schlecht{nicht gut} zu sprechen sein 누구에게 좀 화가 나 있다, 누구가 마음에 안 든다 3. i. 나타나다, 보이다 |
| [abwechseln](https://dict.naver.com/dekodict/#/search?range=all&query=abwechseln) | 1. i. 교대하다 2. t. (jn.) 교대하다, 변경시키다. 3. t. 환전하다 |
...
| [überreden](https://dict.naver.com/dekodict/#/search?range=all&query=überreden) | 1. t. 설득하다, 납득시키다, 권유하다 |
| [überlegen](https://dict.naver.com/dekodict/#/search?range=all&query=überlegen) 1 | 1. t. 숙고하다, 고려하다 2. i. 숙고하다 3. p.a. überlegt ↑ überlegt |
| [verteidigen](https://dict.naver.com/dekodict/#/search?range=all&query=verteidigen) | 1. t. 지키다, 방어하다 2. t. 3. t. 지지하다, 옹호하다, 변호하다 |
| [erziehen](https://dict.naver.com/dekodict/#/search?range=all&query=erziehen) | 1. t. 교육하다, 가르치다, 키우다 2. t. [원예] (식물을) 기르다, 재배하다 3. t. «고어» (말이) 끌다 |
| [ạn\|kündigen](https://dict.naver.com/dekodict/#/entry/deko/a3cdcb6076ce4440bb408f3604029e58) | 1. t. (jm. et.) 통고{통지}하다, 미리 알리다 2. t. 광고하다 3. refl. sich ankündigen |
